...
PARTIDOS_TOTALES = 10 + (NUMERO_DE_EQUIPOS_GRUPO_A * (NUMERO_DE_EQUIPOS_GRUPO_A - 1))//2 + (NUMERO_DE_EQUIPOS_GRUPO_B * (NUMERO_DE_EQUIPOS_GRUPO_B - 1))//2

f = open("competencia_generada.in", "w")
f.write(str(NUMERO_DE_EQUIPOS) + " " + str(PARTIDOS_TOTALES) +"\n")


for x in range(NUMERO_DE_EQUIPOS_GRUPO_A):
	for y in range(x+1, NUMERO_DE_EQUIPOS_GRUPO_A):
		puntaje_1 = random.gauss(0.0, 1)
		puntaje_2 = random.gauss(0.0, 1)
		if x == 0:
			puntaje_1 = random.gauss(9.0, 1)
		if y == 0:
			puntaje_2 = random.gauss(9.0, 1)
...
for x in range(NUMERO_DE_EQUIPOS_GRUPO_B):
	for y in range(x+1, NUMERO_DE_EQUIPOS_GRUPO_B):
...
for i in range(10):
	f.write("1 "+str(NUMERO_DE_EQUIPOS_GRUPO_A+1+i)+" 1 1 0\n")
